...
namespace Sophies_Soraka
{
    ...
    internal class SophiesSoraka
    {
        ...
        private static void AutoW()
        {
            ...
            var canidates = HeroManager.Allies.Where(x => !x.IsMe && (dontWInFountain ? !x.InFountain() : true) && x.IsValidTarget(W.Range, false) && x.HealthPercent < healthPercent);
            ...
            var target = canidates.FirstOrDefault();
